...
// отправка письма
            ...
            $body='Hi, <br/> <br/> Activation! Please follow the link to activate your account. <br/> <br/> <a href="'.$base_url.'activation/'.$activation.'">'.$base_url.'activation/'.$activation.'</a>';
 
            Send_Mail($to,$subject,$body);
            $msg= "Registration completed successfully! Get activation via email.";
        }
        else
        {
...
function Send_Mail($to,$subject,$body)
{
    ...
    $mail->Username   = "375298388602@mail.ru";  // SMTP  имя пользователя
    $mail->Password   = "Q8280431";  // SMTP пароль
